...
<main class="d-flex w-100">
	<div class="container d-flex flex-column">
		<div class="row d-flex justify-content-end">
			<div class="col-sm-10 col-md-8 col-lg-6 h-100" >
				<div class="d-table-cell align-middle"id="cardsignin">
								...
								<form method="POST" action="{{route('login')}}">
									...
									<div class="mb-3">
										...
										@error('email')
                     					 ...
                     					 @enderror
										<input class="@error('email') is-invalid @enderror form-control form-control-lg" type="email" name="email" placeholder="Enter your email" />
									</div>
									<div class="mb-3">
		...
		<span class="form-check-label">
		  Remember me next time
									...
									<div class="text-center mt-3">
									    ...
									    <button type="submit" class="btn btn-lg btn-primary" id="btnsignin">Sign in</button> 
									</div>
								</form>
							</div>
						</div>
